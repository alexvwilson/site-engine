  ...
  return (
    <div className="flex flex-col items-center justify-center py-14">
      ...
      <p className="text-muted-foreground text-center max-w-md mb-8">
        Generate an AI-powered summary of your transcript including key
        highlights, topics, show notes, and social media captions.
      </p>

      <Button className="px-4" onClick={onGenerate} disabled={isGenerating}>
