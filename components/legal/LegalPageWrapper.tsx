...
export default function LegalPageWrapper({
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-b from-background to-muted/20 border-b">
        <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground bg-muted bg-opacity-30 rounded-full px-4 py-2">
        ...
        <div className="max-w-5xl mx-auto">
          <div
            className="prose prose-lg prose-slate dark:prose-invert max-w-none
                         ...
                         [&_blockquote]:border-l-4 [&_blockquote]:border-primary [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:text-muted-foreground [&_blockquote]:my-8 [&_blockquote]:bg-muted [&_blockquote]:py-4 [&_blockquote]:rounded-r-lg
                         [&_section]:mb-12
      ...
      {/* Footer Notice */}
      <div className="border-t bg-muted bg-opacity-30 mb-16">
