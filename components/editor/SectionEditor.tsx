...
export function SectionEditor({ section, siteId }: SectionEditorProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {section.block_type === "hero_primitive" && (
        <HeroPrimitiveEditor {...editorProps} content={content as Parameters<typeof HeroPrimitiveEditor>[0]["content"]} />
      )}
      ...
      {section.block_type === "blog" && (
        <BlogEditor {...editorProps} content={content as Parameters<typeof BlogEditor>[0]["content"]} />
      )}
    </div>
  );
}
