          ...
          <CollapsibleContent className="space-y-6">
            ...
            <div className="space-y-4 rounded-lg border p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  id="show-form-bg"
                  checked={content.showFormBackground ?? true}
                  onCheckedChange={(checked) =>
              ...
              <p className="text-xs text-muted-foreground">
                {content.showFormBackground ?? true
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateField("formBackgroundColor", e.target.value)
                      }
                      disabled={disabled}
                      className="h-10 w-14 rounded border cursor-pointer disabled:opacity-50"
                    />
                    <span className="text-sm text-muted-foreground">
                      {content.formBackgroundColor || "Using theme card style"}
                    </span>
                    {content.formBackgroundColor && (
                      <button
                        type="button"
                        onClick={() => updateField("formBackgroundColor", "")}
                        className="text-xs text-muted-foreground hover:text-foreground underline"
                        disabled={disabled}
                      >
                        Reset
            ...
            <div className="space-y-4 rounded-lg border p-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Scales heading, description, and labels proportionally.
                </p>
              </div>
