...
- Template literals make string interpolation easy`,
  ...
  showcase: [
    {
      id: "showcase-stats-simple",
      name: "Stats Simple",
      description: "Clean stat counters in a row",
      content: {
        mode: "stats",
        sectionTitle: "",
        sectionSubtitle: "",
        stats: [
          { id: "s1", value: 500, suffix: "+", label: "Happy Clients" },
          { id: "s2", value: 10, suffix: "+", label: "Years Experience" },
          { id: "s3", value: 50, suffix: "K", label: "Projects Done" },
          { id: "s4", value: 99, suffix: "%", label: "Success Rate" },
        ],
        statsLayout: 4,
    ...
    {
      id: "showcase-stats-icons",
      name: "Stats with Icons",
      description: "Animated counters with icons",
      content: {
        mode: "stats",
        sectionTitle: "By The Numbers",
        sectionSubtitle: "Our achievements speak for themselves",
        stats: [
          { id: "s1", value: 1000, suffix: "+", label: "Active Users", icon: "users" },
          { id: "s2", value: 50, suffix: "M", label: "Downloads", icon: "download" },
          { id: "s3", value: 99, suffix: "%", label: "Uptime", icon: "activity" },
        ],
        statsLayout: 3,
        animationSpeed: "medium",
        animateOnScroll: true,
    ...
    {
      id: "showcase-stats-styled",
      name: "Stats Styled",
      description: "Stats with background styling",
      content: {
        mode: "stats",
        sectionTitle: "Trusted Worldwide",
        sectionSubtitle: "",
        stats: [
          { id: "s1", value: 150, suffix: "+", label: "Countries" },
          { id: "s2", value: 2, prefix: "$", suffix: "M", label: "Revenue Generated" },
          { id: "s3", value: 500, suffix: "K", label: "Happy Customers" },
    ...
    {
      id: "showcase-downloads-list",
      name: "Downloads List",
      description: "Simple file download list",
      content: {
        mode: "downloads",
        sectionTitle: "Resources",
        sectionSubtitle: "Download our free resources",
        stats: [],
        statsLayout: 4,
        animationSpeed: "medium",
        animateOnScroll: true,
    ...
    {
      id: "showcase-downloads-grid",
      name: "Downloads Grid",
      description: "Resource cards in a grid",
      content: {
        mode: "downloads",
        sectionTitle: "Free Downloads",
        sectionSubtitle: "Helpful resources for your projects",
        stats: [],
        statsLayout: 4,
        animationSpeed: "medium",
        animateOnScroll: true,
        ...
        downloads: [
          ...
          },
          {
            id: "d2",
            title: "Media Kit",
            description: "Press photos and company info",
            fileUrl: "#",
            fileType: "zip",
            fileSize: "45 MB",
    ...
    {
      id: "showcase-resource-library",
      name: "Resource Library",
      description: "Styled downloads section",
      content: {
        mode: "downloads",
        ...
        downloads: [
          ...
          },
          {
            ...
            description: "Pre-built spreadsheets for tracking",
            fileUrl: "#",
            fileType: "xls",
            fileSize: "2 MB",
          },
  ...
  calendar: [
    {
      id: "calendar-events-simple",
      name: "Events List - Simple",
      description: "Clean list of upcoming events",
      content: {
        mode: "list",
    ...
    {
      id: "calendar-events-detailed",
      name: "Events List - Detailed",
      description: "Events with descriptions and locations",
      content: {
        mode: "list",
        sectionTitle: "Upcoming Events",
        sectionSubtitle: "Join us for these exciting opportunities",
        events: [
          {
            id: "ev-1",
            title: "Annual Conference 2026",
            description: "Join industry leaders for a day of insights, networking, and innovation.",
          ...
          },
          {
            ...
            description: "Interactive workshop covering our strategic initiatives for the quarter.",
    ...
    {
      id: "calendar-countdown-webinar",
      name: "Webinar Countdown",
      description: "Countdown to your next webinar",
      content: {
        mode: "countdown",
        sectionTitle: "",
        sectionSubtitle: "",
        ...
        showTimezone: true,
        eventCardStyle: "detailed",
        countdownTitle: "Live Webinar Starting In",
        countdownSubtitle: "Join us for an exclusive session on growing your business online",
        ...
        smallestUnit: "seconds",
        unitLabels: { days: "Days", hours: "Hours", minutes: "Minutes", seconds: "Seconds" },
        completionMessage: "Webinar is Live!",
        showEventDetails: false,
        countdownEventId: "",
        showButton: true,
    ...
    {
      id: "calendar-countdown-launch",
      name: "Launch Countdown",
      description: "Product or course launch countdown",
      content: {
        mode: "countdown",
        sectionTitle: "",
        sectionSubtitle: "",
        ...
        countdownSubtitle: "Be the first to know when we go live",
        targetDate: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000)
          .toISOString()
          .split("T")[0],
        targetTime: "12:00",
        targetTimezone: "America/New_York",
        showUnits: ["days", "hours", "minutes"],
    ...
    {
      id: "calendar-calendly",
      name: "Calendly Booking",
      description: "Embed Calendly scheduling widget",
      content: {
        mode: "embed",
        sectionTitle: "Schedule a Call",
        sectionSubtitle: "Book a time that works for you",
        events: [],
        showAddToCalendar: true,
        showTimezone: true,
        eventCardStyle: "detailed",
    ...
    },
    {
      ...
      description: "Embed Cal.com scheduling widget",
      content: {
        mode: "embed",
        sectionTitle: "Book a Meeting",
        sectionSubtitle: "Select a convenient time slot",
        events: [],
        showAddToCalendar: true,
        showTimezone: true,
        eventCardStyle: "detailed",
