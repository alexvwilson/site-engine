...
Choose the authentication method attached to your Claude subscription plan (not API)
...
Verify you're logged in by running /cost - you should see your subscription info
...
Open Cursor/VS Code settings
Search for "Terminal > Integrated: Send Keybindings To Shell"
Uncheck this option
...
*Note: These shortcuts require custom keybinding setup in Cursor/VS Code. See Custom Keybinding Setup below.
...
Add your custom keybindings to keybindings.json
Example Keybindings:
...
Open File Explorer - CMD/CTRL + SHIFT + E
